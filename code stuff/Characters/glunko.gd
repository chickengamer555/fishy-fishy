...
@onready var emotion_sprites = {
	"neutral": $glunko_emotion/Neutral,
...
PERSONALITY: Use street slang and dealer talk. The alleyway you live in is behind the Squaloon
...
Locations/Characters and how you know them:
	The squaloon with Squileta: You live in the alleyway behind squaloon so Squileta keeps coming out to yell at you for trying to sell stuff to her customers
	Trash heap with Crabcade: He's your idol but you've only seen him from afar and you're scared your goblin shark face will scare him off
